...
void DVP_Config(void)
{
	...
	PORT_Init(PORTC, PIN6,  PORTC_PIN6_DVP_D7,   1);
//	PORT_Init(PORTC, PIN7,  PORTC_PIN7_DVP_D8,   1);
//	PORT_Init(PORTC, PIN8,  PORTC_PIN8_DVP_D9,   1);
//	PORT_Init(PORTA, PIN6,  PORTA_PIN6_DVP_D10,  1);
