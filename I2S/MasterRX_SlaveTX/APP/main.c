...
void DMA_Handler(void)
{
	...
	/* Slave TX */
	if(DMA_CH_INTStat(DMA_CH2, DMA_IT_SRCSG_HALF))
	{
		DMA_CH_INTClr(DMA_CH2, DMA_IT_SRCSG_HALF);
		
		TX_DoneIndex = (1 << 1) | 0;
	}
	else if(DMA_CH_INTStat(DMA_CH2, DMA_IT_SRCSG_DONE))
	{
		DMA_CH_INTClr(DMA_CH2, DMA_IT_SRCSG_DONE);
