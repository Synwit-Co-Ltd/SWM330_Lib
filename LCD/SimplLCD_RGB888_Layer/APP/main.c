...
extern const unsigned char gImage_Synwit128[65536];
...
uint32_t *LCD_Buffer1 = (uint32_t *)(SDRAMM_BASE + 0x000000);
uint32_t *LCD_Buffer2 = (uint32_t *)(SDRAMM_BASE + 0x100000);
...
int main(void)
{
	...
	for(i = 0; i < 128*128; i++)
		LCD_Buffer[i] = ((const uint32_t *)gImage_Synwit128)[i];
