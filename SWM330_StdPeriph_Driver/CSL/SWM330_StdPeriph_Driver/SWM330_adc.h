#ifndef __SWM330_ADC_H__
#define	__SWM330_ADC_H__
...
typedef struct {
	uint16_t channels;		// SEQ convert channel, can be ADC_CH0, ADC_CH1, ... ..., ADC_CH15 and their '|' operation
	uint8_t  trig_src;		// SEQ trigger method, can be ADC_TRIGGER_SW, ADC_TRIGGER_TIMER0, ...
	uint16_t conv_cnt;		// SEQ convert times, can be 1--256
	uint8_t  samp_tim;		// SEQ sample time, can be ADC_SAMPLE_1CLOCK, ADC_SAMPLE_2CLOCK, ..., ADC_SAMPLE_128CLOCK
...
#define ADC_CH0		0x0001
#define ADC_CH1		0x0002
#define ADC_CH2		0x0004
#define ADC_CH3		0x0008
#define ADC_CH4		0x0010
#define ADC_CH5		0x0020
#define ADC_CH6		0x0040
#define ADC_CH7		0x0080
#define ADC_CH8		0x0100
#define ADC_CH9		0x0200
#define ADC_CH10	0x0400
#define ADC_CH11	0x0800
...
#define ADC_TRIGGER_PWM0		8
#define ADC_TRIGGER_PWM1		9
